...
void main() {
  ...
  >
    ...
    />
  </svg>`}function e_({onLoaded:e,loading:t,error:n}){let r=(0,g.useRef)(),i=async t=>{let n=[...t],r=n.find(e=>/airport/i.test(e.name)),i=n.find(e=>/route/i.test(e.name));if(!r||!i)return e(null,null,`Select both airports.dat and routes.dat.`);e(await r.text(),await i.text())};return x` <div
  ...
  </div>`}function t_({node:e,pinned:t,point:n}){if(!e||!n)return null;let r=n.x+18,i=r+295<=innerWidth?r:Math.max(0,n.x-295-18),a=Math.max(12,Math.min(n.y-20,innerHeight-190));return x` <div
  ...
  </div>`}function n_({data:e,options:t,setOptions:n,query:r,setQuery:i,selected:a,selectNode:o,clearSelection:s,open:c}){let l=(0,g.useMemo)(()=>{let t=r.trim().toLowerCase();return t?e.nodes.filter(e=>`${e.id} ${e.name} ${e.city} ${e.country}`.toLowerCase().includes(t)).sort((e,t)=>t.degree-e.degree).slice(0,8):[]},[e,r]);return x` <aside
    id="controls"
  ...
  </div>`}var a_=o((e=>{var t=u(),n=Symbol.for(`react.element`),r=Object.prototype.hasOwnProperty,i=t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,a={key:!0,ref:!0,__self:!0,__source:!0};function o(e,t,o){var s,c={},l=null,u=null;for(s in o!==void 0&&(l=``+o),t.key!==void 0&&(l=``+t.key),t.ref!==void 0&&(u=t.ref),t)r.call(t,s)&&!a.hasOwnProperty(s)&&(c[s]=t[s]);if(e&&e.defaultProps)for(s in t=e.defaultProps,t)c[s]===void 0&&(c[s]=t[s]);return{$$typeof:n,type:e,key:l,ref:u,props:c,_owner:i.current}}e.jsx=o})),o_=o(((e,t)=>{t.exports=a_()}))();(0,_.createRoot)(document.getElementById(`root`)).render((0,o_.jsx)(g.StrictMode,{children:(0,o_.jsx)(i_,{})}));